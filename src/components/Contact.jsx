            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-dark-700/50 border border-dark-600 rounded-none text-white focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors placeholder:text-gray-600"
                  ...
                  {serviceOptions.map((service) => {
                    ...
                    return (
                      <motion.button
                        ...
                        className={`group relative overflow-hidden rounded-none border px-3 py-3 text-left text-sm transition-colors duration-200 active:scale-[0.97] ${
                          isSelected
                ...
                {formData.services.includes('Other') && (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      rows="2"
                      className="w-full px-4 py-3 bg-dark-700/50 border border-dark-600 rounded-none text-white focus:outline-none focus:border-primary-500 focus:ring-1 focus:ring-primary-500 transition-colors resize-none"
